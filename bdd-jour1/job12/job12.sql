...
/*AJOUTER UN ELEVE*/
INSERT INTO etudiants (id,nom, prenom, age, email) VALUES ('6', 'Dupuis', 'Martin', 18, 'martin.dupuis@laplateforme.io');

/*TRIER DE LA MEME FAMILLE*/
SELECT * FROM etudiants WHERE nom='Dupuis';

-- Dump completed on 2023-03-13 14:40:47
